        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="single-product mb-50">
                    ...
                    <div class="location-details">
                        <p class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".1s"><a href="{{ route('about') }}" style="font-size:20px;">Découvrez l'art de la fabrication de nos chapeaux</a></p>
                ...
                <div class="accordion" id="faqAccordion">
                    <div class="card">
                        <div class="card-header" id="faq1">
                            <h5 class="mb-0">
                                <a href="#collapse1" class="btn collapsed" data-toggle="collapse" data-target="#collapse1" aria-expanded="false" aria-controls="collapse1" tabindex="0">
                        ...
                        <div id="collapse1" class="collapse" aria-labelledby="faq1" data-parent="#faqAccordion">
                            <div class="card-body">
                                Comme pour tout vêtement, les chapeaux existent en différentes tailles. La façon correcte de connaître votre taille de chapeau est de placer un mètre ruban autour de votre tête, au niveau du milieu du front.<br><br>
                                <b>Nos tailles disponibles :</b><br>
                                S : 55-56 cm<br>
                                M : 57-58 cm<br>
                                L : 59-60 cm<br>
                                XL : 61 cm
                                <div class="mt-3">
                                    <img src="{{ asset('img/palma/cabeza.png') }}" alt="Guide des tailles" class="img-fluid w-100">
                                </div>
                            </div>
                        </div>
                    </div>
