    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-tittle text-center mb-5">
                    ...
                    <p class="pera" style="font-size: 1.6rem; color: black; line-height: 1.8;">La paille toquilla est une matière organique qui à besoin d’un certain degré d'humidité pour préserver et maintenir sa flexibilité il n'est donc pas recommandé de laisser le chapeau exposé au soleil.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="content-section reverse">
            ...
            <div class="content-text">
                <div style="font-size: 12pt; color: black; line-height: 1.8;">
            ...
            <div class="content-image">
                <img src="{{ asset('img/palma/art1.jpg') }}" alt="Art de Porter" class="animate-image hover-effect" loading="lazy" decoding="async" style="width: 70%; height: auto;">
            </div>
        </div>

        <div class="content-section reverse">
            <div class="content-image">
                <img src="{{ asset('img/palma/art2.jpg') }}" alt="Art de Porter" class="animate-image hover-effect" loading="lazy" decoding="async" style="width: 70%; height: auto;">
            </div>
            <div class="content-text">
                <div style="font-size: 12pt; color: black; line-height: 1.8;">
                    <ul style="list-style: none; padding-left: 0;">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <img src="{{ asset('img/palma/art3.jpg') }}" alt="Chapeau Panama" class="img-fluid hover-effect" loading="lazy" decoding="async"
                        style="width: 100%; height: 300px; object-fit: cover; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{ asset('img/palma/art4.jpeg') }}" alt="Artisan Panama" class="img-fluid hover-effect" loading="lazy" decoding="async"
                        style="width: 100%; height: 300px; object-fit: cover; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); object-position: bottom;">
                </div>
                <div class="col-md-4 mb-4">
                    <img src="{{ asset('img/palma/art5.jpg') }}" alt="Tradition Panama" class="img-fluid hover-effect" loading="lazy" decoding="async"
                        style="width: 100%; height: 300px; object-fit: cover; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                </div>
            </div>
        </div>
...
<style>
    h1, h2, .section-tittle h1, .section-tittle h2 {
        font-size: 40px !important;
        text-align: center !important;
    }
    
    h3, h4, .section-tittle h3 {
        font-size: 18pt !important;
    }
    
    p, .pera, li, div[style*="font-size: 12pt"] {
