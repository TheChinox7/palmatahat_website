...
<div class="about-area py-5">
    <div class="container">
        ...
        <div class="content-section reverse">
            <div class="content-image">
                <img src="{{ asset('img/palma/art2.jpg') }}" alt="Art de Porter" class="animate-image" style="width: 70%; height: auto;">
            </div>
            <div class="content-text">
                <div style="font-size: 1.6rem; color: black; line-height: 1.8;">
                    <ul style="list-style: none; padding-left: 0;">
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <img src="{{ asset('img/palma/art4.jpeg') }}" alt="Artisan Panama" class="img-fluid"
