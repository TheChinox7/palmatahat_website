                ...
                <div class="col-lg-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center" style="font-size: 1.6rem; color: black;">
                            ...
                            <li class="breadcrumb-item"><a style="color: black;">Origine du <b>Panama Haut</b></a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="col-lg-6 mt-3">
                            <div class="section-tittle mb-60 pt-10">
                                <p class="pera" style="font-size: 1.6rem; text-align: justify; color: black;">Le véritable
                                    <b>chapeau Panama</b> est fabriqué en paille Carludovica Palmata, une fibre naturelle provenant
                                    d'Équateur. Bien que son nom prête à confusion, son origine est équatorienne et non
                                    panaméenne. Ce chapeau, appelé localement <b>sombrero de paja toquilla</b>, était à l'origine
                                    porté par des hommes humbles.
                                    <br><br>
                                    La fabrication remonte à 1630, dans la région de Jipijapa, où les peuples indigènes
                                    tissaient ces chapeaux <b>à la main</b>. Dès le 17e siècle, les conquérants espagnols ont
                                    ...
                                    classiques et Montecristi en Suisse, fabriqués par les talentueux <b>artisans</b> équatoriens.
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6 mt-3">
                            <div class="section-tittle mb-60 pt-10">
                                <p class="pera" style="font-size: 1.6rem; text-align: justify; color: black;">Diffusion
                                    ...
                                    C'était ainsi que le chapeau "<b>Panama</b>" devient mondialement célèbre ...
