    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <div class="auth-card shadow-sm">
                <div class="auth-body">
                    <h2 class="auth-title text-center mb-3">{{ __('Confirmer le mot de passe') }}</h2>
                    <p class="text-center text-muted mb-4">{{ __('Veuillez confirmer votre mot de passe avant de continuer.') }}</p>
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}">
                        ...
                        <button type="submit" class="btn auth-btn btn-block mb-3">{{ __('Confirmer') }}</button>
