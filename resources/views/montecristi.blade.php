        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-lg-6 mb-4 mb-lg-0 order-2 order-lg-1 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                            <p class="pera responsive-text" style="line-height: 1.6; color: #000;">
