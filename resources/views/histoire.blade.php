                ...
                <div class="row gallery-row m-0">
                    <div class="col-lg-3 col-md-6 col-6 p-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="gallery-hover">
                            <img src="{{ asset('img/palma/plaza.png') }}" alt="Chapeau Panama élégant" class="img-fluid w-100 h-100" style="object-fit: cover;">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-6 p-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                        <div class="gallery-hover">
                            <img src="{{ asset('img/palma/paja.jpg') }}" alt="Tradition et style Panama" class="img-fluid w-100 h-100" style="object-fit: cover;">
                        </div>
                    </div>
